...
def test_write_yaml(config, tmp_path):
    ...
    config.set_build_jobs(build_jobs=8)
    config.set_cache_paths(source_cache_path="/path/to/source", misc_cache_path="/path/to/misc")
    config.set_stage_paths(build_stage_path="/path/to/build", test_stage_path="/path/to/test")
